...
namespace SpeedrunComSharp
{
    public class Assets
    {
        ...
        public static Assets Parse(SpeedrunComClient client, dynamic assetsElement)
        {
            ...
            var properties = assetsElement as IDictionary<string, dynamic>;

            assets.Logo = ImageAsset.Parse(client, properties["logo"]) as ImageAsset;
            ...
            assets.Icon = ImageAsset.Parse(client, properties["icon"]) as ImageAsset;
            ...
            assets.BackgroundImage = ImageAsset.Parse(client, properties["background"]) as ImageAsset;
            assets.ForegroundImage = ImageAsset.Parse(client, properties["foreground"]) as ImageAsset;
